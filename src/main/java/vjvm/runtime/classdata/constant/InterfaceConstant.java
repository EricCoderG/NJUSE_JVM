...
public class InterfaceConstant extends Constant{
  @Getter
  ...
  @SneakyThrows
  public InterfaceConstant(DataInput dataInput, JClass self) {
  ...
  public String toString() {
    return String.format("InterfaceMethodref: %s.%s", className(), name_and_type());
  }
